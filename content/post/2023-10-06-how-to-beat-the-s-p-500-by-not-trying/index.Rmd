...
table <- kable(tmp, caption = "Table 1: Funds Analyzed Through the 'Buffet's Alpha Framework'",
               row.names=FALSE)
...
table <- kable(tmp, caption = "Table 2: Attributing Fund Performance To Factors", row.names=FALSE)
table %>%
  kable_styling(full_width = FALSE)
...
table <- kable(tmp, caption = "Table 3: In-Sample and Expected Performance Metrics of Based on a Six-Factor Framework", row.names=FALSE)
table %>%
  kable_styling(full_width = FALSE)
