...
names(done) = c( names(done)[1:8],"Terminal Value to Value","Suitable to Value Investor?")
...
names(alldone) = c("Ticker","Name","Excess Value","Margin Attribution", "Growth Attribution", "Suitable to Value Investor?")
kable(alldone)
```